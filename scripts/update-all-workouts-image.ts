...
async function main() {
  ...
  // Ömer İlhan's workouts based on the image
  // Day 1, 2, 3, 4, 5, 6, 7, 8, 10, 11, 12 (11 workouts)
  const omerWorkouts = [
    '2025-10-27', // Day 1
    '2025-10-28', // Day 2
    '2025-10-29', // Day 3
  ...
  // Egemen Başar's workouts based on the image
  // Day 5, 6, 7, 9, 10, 11, 12, 13 (8 workouts)
  ...
  // Bayram Çakır's workouts based on the image
  // Day 1, 3, 4, 5, 6, 7, 8, 10, 13 (9 workouts)
