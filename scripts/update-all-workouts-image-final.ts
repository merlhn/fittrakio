...
async function main() {
  ...
  // Ömer İlhan's workouts based on the image (11 workouts)
  const omerWorkouts = [
    '2025-10-27', // Day 1
    '2025-10-28', // Day 2
    '2025-10-30', // Day 4
  ...
  // Egemen Başar's workouts based on the image (9 workouts)
  ...
  // Bayram Çakır's workouts based on the image (8 workouts)
